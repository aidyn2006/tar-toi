...
const ContactPage = () => {
    ...
    const jsonLd = [
        ...
        },
        {
            '@context': 'https://schema.org',
            '@type': 'ContactPage',
            name: lang === 'ru' ? `Контакты ${SITE_META.brandName}` : `${SITE_META.brandName} байланыс беті`,
        ...
        <Layout>
            ...
            <section style={{ paddingTop: '8rem', paddingBottom: '5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem', maxWidth: '72rem', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                    <a href={SITE_META.supportWhatsappUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                        <div style={{ padding: '3rem', borderRadius: '2rem', background: '#f0fdf4', border: '1px solid rgba(16,185,129,0.15)', textAlign: 'center', transition: 'all 0.3s ease' }}>
                            ...
                            <div style={{ color: '#10b981', fontSize: '1.1rem', fontWeight: 700 }}>{SITE_META.supportPhoneDisplay}</div>
                        </div>
                    </a>

                    <a href={SITE_META.instagramUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                        <div style={{ padding: '3rem', borderRadius: '2rem', background: '#fffbeb', border: '1px solid rgba(251,191,36,0.2)', textAlign: 'center', transition: 'all 0.3s ease' }}>
                            ...
                            <div style={{ color: '#f59e0b', fontSize: '1.1rem', fontWeight: 700 }}>{SITE_META.instagramHandle}</div>
                        </div>
                    </a>

                    <a href={SITE_META.supportPhoneHref} style={{ textDecoration: 'none' }}>
                        <div style={{ padding: '3rem', borderRadius: '2rem', background: '#f0fdf4', border: '1px solid rgba(16,185,129,0.15)', textAlign: 'center', transition: 'all 0.3s ease' }}>
